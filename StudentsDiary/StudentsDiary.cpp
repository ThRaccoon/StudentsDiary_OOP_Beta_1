...
void StudentsDiary::addGrades()
{
	...
	if (it != m_students.end())
	{
		...
		if (it != m_grades.end())
		{
			std::cout << "This student already have grade list!" << std::endl;
		}
		else
		{
			gradeid = wantedId;
...
void StudentsDiary::showStudentAndGradesListInOrder()
{
	...
	if (size > 0) {
		...
		for (int i = 0; i < m_students.size(); i++)
		{
			...
			{
				std::cout << "Student math grade: NA" << std::endl;
				std::cout << "Student bg grade: NA" << std::endl;
				std::cout << "Student en grade: NA" << std::endl;
				std::cout << "Student grade ID is: NA" << std::endl;
			}
			std::cout << "-------------------------------" << std::endl;
		}
	}
...
void StudentsDiary::changeGradesInfo()
{
	...
	if(it != m_grades.end())
	{
		...
		m_grades.push_back(StudentGrades(math, bg, en, gradeid));
	}
}
